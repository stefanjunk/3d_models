...
6. **Kennzeichnung** — add one compact sidebar-style bullet or at most two short lines naming the `metriMade.com` asset revision, product ID/version, placement, and PASS/approved state.
