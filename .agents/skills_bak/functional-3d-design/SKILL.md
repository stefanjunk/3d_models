...
13. JuSt Innovation watermark placement, sizing, validation, and approval evidence;
...
12. **Watermark integration** — as the last planned design-feature/solid-geometry change, select the standard or compact JuSt Innovation profile for the largest safe print-bed-facing underside region, subtract it at the approved depth, and verify host-wall reserve and finished-underside reading direction.
