...
Do not emit a final package when this command fails. Later changes to the marked design geometry, unvalidated export/simplification policy, orientation, print profile, or watermark invalidate approval and require this gate again.
