...
- Die drei lokalen Dateien `camera_mount/external/1.stl`, `2.stl` und `3.stl` wurden per SHA-256 mit dem von der offiziellen Anycubic-Kameraseite verlinkten Google-Drive-Ordner abgeglichen; alle drei stimmen bytegenau überein.
