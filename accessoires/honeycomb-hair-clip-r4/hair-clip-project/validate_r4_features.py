#!/usr/bin/env python3
"""Revision-4 acceptance checks for the generated honeycomb hair clip."""
...
def main() -> None:
    ...
    checks = {
        "revision_is_4": metrics["revision"] == 4,
        "uniform_pointy_hexagons": armor["cellShape"] == "uniform-pointy-regular-hexagon",
        "true_staggered_honeycomb": armor["layout"] == "true-staggered-honeycomb-lattice",
        "five_rows_of_three_cells": armor["rowCount"] == 5 and armor["cellsPerRow"] == [3, 3, 3, 3, 3],
        "only_three_build_side_half_cells": armor["buildSideHalfCellCount"] == 3,
        "twelve_cells_remain_whole": armor["fullCellCount"] == 12,
    ...
    result = {
        ...
        "note": "Digital lattice and mesh gates passed only if every value is true; PETG fatigue and latch behavior still require the coupon test.",
    }
