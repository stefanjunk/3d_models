...
Source:
`../../../libraries/fdm-mechanics-library-v1.0.0/samples/01_rotation_1d/002-offset-pin-hinge-standard/`
...
Source:
`../../../libraries/fdm-mechanics-library-v1.0.0/samples/06_reusable_closures/078-bayonet-quarter-turn-030/`
...
Source:
`../../../libraries/fdm-mechanics-library-v1.0.0/samples/08_drives_and_components/109-split-shaft-coupler-d4/`
