...
def main() -> int:
    ...
    values = {
        ...
        # Discrete spiral staircase (v3 interior)
        "stair_steps": spiral["step_count"],
        "stair_index_angle": spiral["step_index_angle_deg"],
        "stair_arc": spiral["step_arc_deg"],
        "stair_t0": spiral["first_step_high_end_azimuth_deg"],
        "stair_z_first": spiral["z_first_step_high_end_mm"],
        "stair_descent": spiral["descent_per_step_mm"],
        "stair_thickness": spiral["thickness_mm"],
        "stair_edge_radius": spiral["edge_radius_mm"],
        "stair_in_rx": spiral["inner_ellipse_rx_mm"],
        "stair_in_ry": spiral["inner_ellipse_ry_mm"],
        "stair_out_rx": spiral["outer_ellipse_rx_mm"],
        "stair_out_ry": spiral["outer_ellipse_ry_mm"],
        "stair_subdiv": 4,
