...
def render(metadata_path: Path, output_dir: Path) -> list[Path]:
    ...
    fig.suptitle("DRAFT R2 · Kennzeichnung auf allen drei Primärgehäusen", fontsize=15, fontweight="bold")
    overview_path = output_dir / "DRAFT_R2_watermark_underside.png"
    ...
    closeup_path = output_dir / "DRAFT_R2_watermark_closeup.png"
    ...
    section_path = output_dir / "DRAFT_R2_watermark_section.png"
    ...
    layer_path = output_dir / "DRAFT_R2_watermark_geometric_layers.png"
