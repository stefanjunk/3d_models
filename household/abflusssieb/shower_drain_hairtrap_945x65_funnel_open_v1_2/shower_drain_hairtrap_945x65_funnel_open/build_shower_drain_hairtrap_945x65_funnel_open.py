...
def write_readme():
    ...
    txt = f"""# Shower drain hair trap – exact 945 × 65 × 20 mm, inverted U-profile, funnel catcher variant – larger-open-area revision

Generated parametrically from `build_shower_drain_hairtrap_945x65_funnel_open.py`.
...
- Start with the `functional_test_tile_75mm.stl` to validate support scarring, funnel cleanup, and hair retention before printing all 4 segments
"""
...
def main():
    ...
    export_shape(tile, "functional_test_tile_75mm")
