...
export declare type Polygons = SimplePolygon|SimplePolygon[];

export declare type RayHit = {
    faceID: number,
    distance: number,
    position: Vec3,
    normal: Vec3
 ...
 * @hidden
 */
export declare interface SealedFloat32Array<N extends number> extends Float32Array {
    length: N;
}
 ...
 * @hidden
 */
export declare interface SealedUint32Array<N extends number> extends Uint32Array {
    length: N;
}
 ...
 * @group Scene Graph
 */
export declare class VisualizationGLTFNode extends BaseGLTFNode {
    /** @internal */
