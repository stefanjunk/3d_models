...
def main():
    ...
    # The assembly STL is already simplified as a closed preview mesh. Keep all
    # of its triangles so uniform triangle dropping cannot create visual holes.
    shown = tris
    ...
    collection = Poly3DCollection(
        shown, facecolors=colors, edgecolors="none", linewidths=0, zsort="min"
    )
    ...
    ax.set_title(
        "Modern Carbon Desk Organizer — CAD form preview (engraving omitted)",
        fontsize=14,
        pad=4,
    )
