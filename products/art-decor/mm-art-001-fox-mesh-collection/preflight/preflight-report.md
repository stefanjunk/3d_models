# Retrospective 3D-design preflight — Mm Art 001 Fox Mesh Collection

`Mm Art 001 Fox Mesh Collection | C0 (13.0/100) | R1 | K0 | Lane E | LOW_UNKNOWN`
...
- Purpose: Provide printable fox-themed decorative meshes and their reference assets for non-functional display use.
...
| PAR | 1 | The current evidence exposes approximately 4 distinct geometry-file stems; exports may duplicate physical parts. |
...
- `textured_mesh.3mf`
- `prompt.md`
- `tripodsg/tmpibp9kn1u.glb`
- `tripodsg/tmpcg4f2rw4.glb`
- `direct3D-2/20260718173506.obj`
