...
module watermark_profile_core() {
    union() {
        translate([0.80000, 0.80000])
            scale(9.60000 / 238)
            import("metrimade-watermark-MM-ART-011-v0.3.0-compact-icon-source.svg", center = false);
        translate([9.60000, 7.40000])
            fitted_text("metriMade.com", 29.77929, 3.00000);
        translate([9.60000, 4.00000])
            fitted_text("MM-ART-011", 24.04772, 2.80000);
        translate([9.60000, 0.80000])
            fitted_text("v0.3.0", 12.42989, 2.80000);
    }
}
