# Image-to-3D component brief — RHENISH_HEIGHTFIELD: Rhenish lignite district global 16-bit height field and six seam-locked relief bodies

## Identity and authority

- Role: current mine-region terrain geometry, aspect, global vertical scale and Z-band authority
- Authority: `hybrid`; representation: `heightmap`
- Source: `derived` — immutable GeoBasis NRW DGM1 snapshot, DEC-RHENISH-DATA-001, REQ-HEIGHT, REQ-COLOR
...
- Required views: source/rhenish/geobasis-nrw-dgm1-master.tif, build/rhenish/rhenish-master-16bit.preview.png
- Positive prompt: Process the frozen official DGM1 acquisition state as one continuous 600 x 400 mm physical terrain field, preserve elevations and aspect, use one global vertical transform, keep seams exact, and retain major open-cast mine benches within a 7 mm relief budget.
- Exclude: invented mine geometry, per-tile normalization, anisotropic stretch, posterization, photographic land cover, texture noise, independent tile color thresholds
...
|---|---|---|
| RHENISH-BL | [0, 0, 3] | global lower-left relief datum |
| RHENISH-BR | [600, 0, 3] | global lower-right relief datum |
| RHENISH-TL | [0, 400, 3] | global upper-left relief datum |

## Interfaces and keep-outs

- `IF-TILE-RHENISH`: TERRAIN_TILE_SET ↔ RHENISH_HEIGHTFIELD
