# Retrospective 3D-design preflight — Mm Sys 004 Billy Collection Riser

`Mm Sys 004 Billy Collection Riser | C3 (40.0/100) | R2 | K2 | Lane E | LOW_UNKNOWN`
...
- Purpose: Provide a parametric one-piece FDM concept for a three-level collection riser; the host-furniture interface remains provisional until measured and physically tested.
