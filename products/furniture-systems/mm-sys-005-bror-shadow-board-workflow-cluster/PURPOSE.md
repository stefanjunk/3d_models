# Purpose — Mm Sys 005 Bror Shadow Board Workflow Cluster

Provide a parametric one-piece FDM concept for a tool-holder workflow cluster; the host-furniture interface remains provisional until measured and physically tested.
