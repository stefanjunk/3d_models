# Retrospective 3D-design preflight — Mm Sys 018 Billy Collection Display Matrix

`Mm Sys 018 Billy Collection Display Matrix | C3 (40.0/100) | R2 | K1 | Lane E | LOW_UNKNOWN`
...
- Purpose: Provide a parametric one-piece FDM concept for a three-level open display matrix; the host-furniture interface remains provisional until measured and physically tested.
