...
module watermark_profile_core() {
    union() {
        translate([0.8, 0.8]) scale(11.2 / 238)
            import("metrimade-watermark-MM-BTH-003-v3.1.0-draft.1-icon-source.svg", center = false);
        translate([11.2, 7.4])
            fitted_text("metriMade.com", 43.67630, 4.4);
        translate([11.2, 1.8])
            fitted_text("MM-BTH-003 · v3.1.0-draft.1", 67.60213, 3.6);
    }
}
