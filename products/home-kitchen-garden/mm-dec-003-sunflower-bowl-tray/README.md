...
- profilgebundenes P2-Print-Set: `p2-stage/MM-DEC-003-0.2.0-print-set.3mf`
- P2-Handoff-Vertrag: `p2-stage/p2-manifest.json`
...
Der produktlokale P2-Handoff bindet eine englische Entwurfsbeschreibung, die vollständige Konzeptansicht, einen Render des aktuellen Meshes und das vollständige einteilige 3MF-Print-Set derselben Revision. Die zentrale Portfolio-Hochstufung bleibt Aufgabe des Main-Integrationsverantwortlichen.
