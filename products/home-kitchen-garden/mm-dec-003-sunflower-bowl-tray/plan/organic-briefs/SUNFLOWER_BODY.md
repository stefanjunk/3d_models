...
- Target project envelope: `[-100, -100, 0] → [100, 100, 65] (200 × 200 × 65 mm)`
...
- `IF-BODY-BED-DATUM`: SUNFLOWER_BODY ↔ FOOT_DISC
  ...
  - local origin: `[0, 0, 0]`
  - assembly: positive disc Boolean union with 5.9 mm nominal overlap and 0.1 mm pre-registration protrusion along +Z
