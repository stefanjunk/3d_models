export const P = Object.freeze({
  ...
  stage1: {
    ...
    inletAxisX: 130,
    inletAxisZ: 220,
    inletFlangeRadius: 22,
    inletPassageID: 18,
    inletTubeOD: 28,
    sedimentFunnelOuterRadius: 138,
    sedimentFunnelInnerRadius: 28,
...
export function derived(p = P) {
  ...
  const assembledHeight = stage1AssemblyZ + p.common.bodyHeight;
