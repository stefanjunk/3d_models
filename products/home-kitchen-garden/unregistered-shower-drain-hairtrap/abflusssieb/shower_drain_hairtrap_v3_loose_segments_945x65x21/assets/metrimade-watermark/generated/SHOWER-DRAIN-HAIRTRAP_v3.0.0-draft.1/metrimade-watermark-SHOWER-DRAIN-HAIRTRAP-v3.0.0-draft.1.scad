// Generated by tools/generate_watermark.py — MM-WM-001-R1
mode = "cutter"; // [profile,cutter,coupon]
engraving_depth = 0.40;
profile_width = 113.466;
...
module watermark_profile_core() {
    union() {
        translate([0.8, 0.8]) scale(11.2 / 238)
            import("metrimade-watermark-SHOWER-DRAIN-HAIRTRAP-v3.0.0-draft.1-icon-source.svg", center = false);
        translate([11.2, 7.4])
            fitted_text("metriMade.com", 43.67630, 4.4);
        translate([11.2, 1.8])
            fitted_text("SHOWER-DRAIN-HAIRTRAP · v3.0.0-draft.1", 101.26559, 3.6);
    }
}
