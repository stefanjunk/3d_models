# Retrospective 3D-design preflight — Unregistered Shower Drain Hairtrap

`Unregistered Shower Drain Hairtrap | C2 (39.2/100) | R0 | K2 | Lane E | LOW_UNKNOWN`
...
- Purpose: Develop or collect a printable shower-drain hair trap; the target drain variant and functional requirements are not yet documented.
...
|---|---|---:|---:|---|
| `IF-ENV-FLU-FLW-VOLUME-001` | Printed product to process medium | E0 | K2 | PLANNED |
