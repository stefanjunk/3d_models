...
def main() -> int:
    ...
    renders = (
        ("DRAFT-R1.4-procedural-steel-model-preview.png", "overall"),
        ("DRAFT-R1.4-procedural-steel-hardware-closeup.png", "hardware-front"),
        ("DRAFT-R1.4-procedural-steel-texture-coupon.png", "coupon"),
    )
