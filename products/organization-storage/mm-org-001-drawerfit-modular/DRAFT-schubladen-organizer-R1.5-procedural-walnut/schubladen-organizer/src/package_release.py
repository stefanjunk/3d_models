...
def main() -> None:
    ...
    current_outputs = [
        ...
        output_dir / "DRAFT-walnut-texture-coupon.stl",
    ...
    top_level = [
        ...
        for name in (
            ...
            "package.json",
            "package-lock.json",
            "concept-R1.5-procedural-walnut.png",
        )
    ]
    legacy_source_names = {
        "build.mjs",
        ...
        "relief.mjs",
        "prepare_relief.py",
        "vectorize_heightmap.py",
        "validate_continuous_relief.py",
        "validate_aspect_ratio.py",
        "validate_aspect_diagnostic.py",
        "test_aspect_preservation.py",
        "package_compact_release.py",
    }
    source_files = [path for path in relative_files("src", ("*.py", "*.mjs")) if path.name not in legacy_source_names]
    config_files = [ROOT / "config" / "model-params.json", ROOT / "config" / "surface-texture.json"]
    ...
    report_names = (
        ...
        "geometry-sha256.txt",
        "wood-texture-plan-floor.json",
        "wood-texture-plan-wall.json",
        "wood-texture-plan-wall-top.json",
        ...
        "DRAFT-R1.5-procedural-walnut-model-preview.png",
        "DRAFT-R1.5-procedural-walnut-hardware-closeup.png",
        "DRAFT-R1.5-procedural-walnut-texture-coupon.png",
    )
    ...
    manifest = {
        ...
        "one_command_rebuild": "python3 rebuild.py",
        "files": [
            {
