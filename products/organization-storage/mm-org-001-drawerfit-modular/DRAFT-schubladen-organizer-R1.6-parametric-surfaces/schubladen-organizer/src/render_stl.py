...
def main() -> None:
    ...
    parser.add_argument("--surface", choices=surface_choices(Path(__file__).resolve().parent.parent))
    ...
    palettes = {
        "carbon": [(38, 42, 47), (42, 46, 51), (46, 50, 55), (50, 54, 59), (62, 66, 71)],
        "carbon-wave": [(34, 40, 47), (38, 44, 51), (42, 48, 55), (46, 52, 59), (58, 64, 71)],
        "micro-cast": [(68, 72, 76), (72, 76, 80), (76, 80, 84), (80, 84, 88), (92, 96, 100)],
        "steel": [(98, 104, 110), (105, 111, 117), (112, 118, 124), (119, 125, 131), (132, 138, 144)],
        "walnut": [(104, 67, 43), (110, 72, 46), (116, 77, 49), (122, 82, 52), (133, 91, 59)],
        "plain": [(105, 113, 122), (110, 118, 127), (115, 123, 132), (120, 128, 137), (135, 143, 151)],
    }
    colors = palettes[surface_id]
    files = [
        ("DRAFT-driver-front-surface.stl", np.array([0.0, 0.0, 0.0]), np.array(colors[0])),
        ("DRAFT-driver-back-surface.stl", np.array([0.0, split, 0.0]), np.array(colors[1])),
        ("DRAFT-hardware-front-surface.stl", np.array([zone, 0.0, 0.0]), np.array(colors[2])),
        ("DRAFT-hardware-back-surface.stl", np.array([zone, split, 0.0]), np.array(colors[3])),
        ("DRAFT-screwdriver-comb.stl", np.array([4.0, split - 5.0, floor]), np.array(colors[4])),
    ]
    if args.view == "coupon":
        files = [("DRAFT-surface-texture-coupon.stl", np.array([0.0, 0.0, 0.0]), np.array(colors[2]))]
