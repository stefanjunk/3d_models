...
## 2026-08-21 – R1.4 prozedurale Stahltextur freigegeben und umgesetzt

- Nutzerwunsch: die als unansehnlich bewertete Bildgravur durch eine hochdetaillierte, nahezu realistische Stahl-/Metalltextur ersetzen.
- Sichtflächen: alle Fachböden, inneren Seitenwände und Wandoberseiten; Außenflächen und Funktionszonen bleiben glatt.
- Nutzerfreigaben: Oberflächenanforderung, Konzept und detaillierte Umsetzung wurden ausdrücklich genehmigt.
- Produktionsentscheidung: deterministisches mehrskaliges analytisches Dellenfeld statt Heightmap. Dadurch existiert kein Bild-Fit und kein Seitenverhältnis-Risiko mehr.
- Materialwirkung: groß-/mittelmaßstäbliche flache Schmiede-/Gussdellen als CAD; sub-düsige Kratzer und gerichteter Glanz entstehen über Metalloptik-PETG und Slicer-Pfadrichtung.
- Schutzstrategie: explizite Keep-outs an Connectoren, Wandknoten, Griffnuten, Gussets, Wandtop-Rändern, Bettauflage und Kennzeichnung.
- Speicherstrategie: vier Module und Texturpatches sequenziell; gemessener Peak 326,215 MiB statt etwa 2.084 MiB bei R1.3.
- Meshstrategie: zusätzliche verlustbehaftete Decimation als `not-beneficial` verworfen; die analytische Neumodellierung senkt die Hauptmodule bereits auf ungefähr 114.000–161.000 Dreiecke.
- Connectorbefund: alle X-/Y-Verbinder verwenden runde Lug-Geometrie; Dreiecksprismen sind Wandwurzel-Gussets. Connector-Coupons sind byte-identisch zu R1.3, daher ist die gemeldete reale Nichtpassung nicht als behoben anzusehen und erfordert einen gemessenen Coupon.
- Gate-Status: digital validierter `DRAFT`; physische Textur-/Connector-Coupons, Ziel-Slicer-Vorschau und finale Freigabe bleiben offen.
