...
def main() -> None:
    ...
    current_outputs = [
        ...
        output_dir / "DRAFT-steel-texture-coupon.stl",
    ...
    top_level = [
        ...
        for name in (
            ...
            "package.json",
            "package-lock.json",
            "concept-R1.4-procedural-steel.png",
        )
    ]
    legacy_source_names = {
        "build.mjs",
    ...
    report_names = (
        ...
        "DRAFT-R1.4-procedural-steel-model-preview.png",
        "DRAFT-R1.4-procedural-steel-hardware-closeup.png",
        "DRAFT-R1.4-procedural-steel-texture-coupon.png",
    )
