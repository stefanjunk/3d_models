...
OUTPUT = ROOT / "renders" / "MM-ORG-003-compact-digital-candidate-draft.2.png"
...
def main() -> None:
    ...
    add_part(ax, MASTER / f"DRAFT-MM-ORG-003-compact-housing-{REVISION}-assembly-source.stl", (0.0, 0.0, 0.0), "#56677b")
    drawer = MASTER / f"DRAFT-MM-ORG-003-compact-drawer-print-twice-{REVISION}-assembly-source.stl"
    add_part(ax, drawer, (3.45, 0.0, 3.25), "#334052")
    add_part(ax, drawer, (3.45, 0.0, 55.75), "#354356")
    add_part(ax, MASTER / f"DRAFT-MM-ORG-003-compact-top-sorter-{REVISION}-assembly-source.stl", (0.0, 0.0, 108.0), "#687b91")
    ...
    fig.text(0.055, 0.94, "MM-ORG-003 · COMPACT 2.0 · DRAFT.2", color="#eef4fb", fontsize=18, fontweight="bold")
    fig.text(0.057, 0.905, "210 × 193.2 × 173 mm · 2 drawers · removable 2 × 3 sorter", color="#aebed0", fontsize=10.5)
