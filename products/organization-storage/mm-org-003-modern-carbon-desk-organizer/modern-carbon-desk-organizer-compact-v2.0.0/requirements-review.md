...
Status: `AUTO_APPROVED` for `MM-ORG-003 · 2.0.0-draft.1` under the project autonomy policy.
...
| Envelope | 210 × 190 × 173 mm assembled | recommended for 220 mm printers |
...
| Texture | parametric 4.8 mm twill grooves, 0.80 mm wide × 0.24 mm deep | recommended by the surface-texture representation ladder |
