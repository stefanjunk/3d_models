# Retrospective 3D-design preflight — Charging Cable Docking Bar

`Charging Cable Docking Bar | C3 (42.5/100) | R2 | K1 | Lane E | LOW_UNKNOWN`
...
- Purpose: Parametric passive docking bar with a rigid PETG frame and replaceable TPU cable inserts. The default set provides four sockets and four insert sizes so charging/data cable ends remain accessible instead of falling behind furniture.
...
| PAR | 3 | The current evidence exposes approximately 15 distinct geometry-file stems; exports may duplicate physical parts. |
