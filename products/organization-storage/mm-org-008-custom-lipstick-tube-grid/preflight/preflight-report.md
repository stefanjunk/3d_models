# Retrospective 3D-design preflight — Custom Lipstick And Tube Grid

`Custom Lipstick And Tube Grid | C2 (34.8/100) | R2 | K1 | Lane E | LOW_UNKNOWN`
...
- Purpose: Parametric support-free PETG vanity organizer implementing Research Ideas 100 `SKU-006`. The default is a 4 × 3 mixed-diameter grid plus a seven-hole diameter capture guide. Generate with `python3 cad/build.py`.
