# Retrospective 3D-design preflight — Tapered Drawer Perimeter Filler Rail Set

`Tapered Drawer Perimeter Filler Rail Set | C2 (37.2/100) | R2 | K2 | Lane E | LOW_UNKNOWN`
...
- Purpose: Close wedge-shaped side gaps between a rectangular drawer-organizer grid and tapered or out-of-square drawer walls using two independently parameterized loose rails.
