#!/usr/bin/env python3
"""Create the hash-bound digital print-candidate report for MM-ORG-012."""
...
REPORTS = [
    ...
    ROOT / "validation/fdm-mesh-tray.json",
    ROOT / "validation/fdm-mesh-coupon.json",
    ROOT / "validation/fdm-3mf.json",
    ROOT / "validation/slicer-anycubic-next.json",
...
def main() -> None:
    ...
    checks.extend(
        [
            ...
            check("physical-gate-deferred", True, "Physical package fit, retrieval and cycle checks remain outside this digital candidate"),
    ...
    output = {
        "schema_version": "1.0",
        "tool": "MM-ORG-012-finalize-digital-candidate",
        ...
        "limitations": [
            "The eight default refill-package envelopes are dimensional simulations, not measured customer packages.",
