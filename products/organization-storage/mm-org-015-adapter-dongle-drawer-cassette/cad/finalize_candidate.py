#!/usr/bin/env python3
"""Create the hash-bound digital print-candidate report for MM-ORG-015."""
...
REPORT_PATHS = [
    ...
    "validation/fdm-mesh-measurement-card.json",
...
def main() -> None:
    ...
    checks.extend(
        [
            ...
            check("physical-gate-deferred", True, "Actual item fit, surface marking, connector load, drawer closure and cycles remain outside this digital candidate"),
    ...
    output = {
        "schema_version": "1.0",
        "tool": "MM-ORG-015-finalize-digital-candidate",
        ...
        "limitations": [
            "Twenty generic item classes are workflow fixtures until replaced by measured customer items.",
            "Headless slicing does not replace layer-preview inspection or a physical print.",
            "The measurement card is coarse; calipers remain authoritative.",
