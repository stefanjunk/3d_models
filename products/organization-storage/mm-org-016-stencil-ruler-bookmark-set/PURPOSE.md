# Purpose — Stencil Ruler Bookmark Set

Keep 4 mm, 5 mm and original signal-mark layout tools inside an A5 or A6 journal without a paper-pinching clip.

## Scope status

- Product ID: `MM-ORG-016`
...
The current preflight decision is `GO_WITH_CONTROLS`. See
