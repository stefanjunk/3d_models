# Retrospective 3D-design preflight — Mm Org 020 Belt Scarf Shelf Comb

`Mm Org 020 Belt Scarf Shelf Comb | C2 (37.2/100) | R2 | K2 | Lane E | LOW_UNKNOWN`
...
- Purpose: Draft digital print candidate for SKU-125 (opportunity score 89.0). The family stores rolled dry soft goods directly on an existing shelf between rounded full-depth fins, so lint can escape and each roll remains visible.
