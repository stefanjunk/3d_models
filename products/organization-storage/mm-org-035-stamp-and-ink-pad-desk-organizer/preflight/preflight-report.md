# Retrospective 3D-design preflight — Inknest Duo

`Inknest Duo | C2 (37.2/100) | R2 | K1 | Lane E | LOW_UNKNOWN`
...
- Purpose: Controlled parametric implementation of portfolio research item `SKU-047`.
