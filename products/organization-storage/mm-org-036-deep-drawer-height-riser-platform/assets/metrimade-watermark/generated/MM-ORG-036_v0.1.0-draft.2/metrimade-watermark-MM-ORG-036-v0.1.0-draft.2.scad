...
module watermark_profile_core() {
    union() {
        translate([0.80000, 0.80000])
            scale(11.20000 / 238)
            import("metrimade-watermark-MM-ORG-036-v0.1.0-draft.2-icon-source.svg", center = false);
        translate([11.20000, 7.40000])
            fitted_text("metriMade.com", 43.67630, 4.40000);
        translate([11.20000, 1.80000])
            fitted_text("MM-ORG-036 · v0.1.0-draft.2", 69.03888, 3.60000);
    }
}
