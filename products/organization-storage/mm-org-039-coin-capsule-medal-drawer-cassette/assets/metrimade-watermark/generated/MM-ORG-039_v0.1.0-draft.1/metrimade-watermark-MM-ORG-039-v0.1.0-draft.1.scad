...
module watermark_profile_core() {
    union() {
        translate([0.80000, 0.80000])
            scale(11.20000 / 238)
            import("metrimade-watermark-MM-ORG-039-v0.1.0-draft.1-icon-source.svg", center = false);
        translate([11.20000, 7.40000])
            fitted_text("metriMade.com", 43.67630, 4.40000);
        translate([11.20000, 1.80000])
            fitted_text("MM-ORG-039 · v0.1.0-draft.1", 68.00795, 3.60000);
    }
}
