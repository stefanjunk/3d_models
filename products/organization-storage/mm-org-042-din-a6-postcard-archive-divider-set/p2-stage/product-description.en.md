# MM-ORG-042 DIN A6 postcard archive divider set
...
This English development description applies to `MM-ORG-042` revision `0.1.0`.
The complete candidate 3MF contains 1 declared print object(s):
divider-block.stl. The included project preserves the selected build orientation and
