...
module watermark_profile_core() {
    union() {
        translate([0.80000, 0.80000])
            scale(9.60000 / 238)
            import("metrimade-watermark-MM-ORG-001-v0.1.0-compact-icon-source.svg", center = false);
        translate([9.60000, 7.40000])
            fitted_text("metriMade.com", 29.77929, 3.00000);
        translate([9.60000, 4.00000])
            fitted_text("MM-ORG-001", 25.28302, 2.80000);
        translate([9.60000, 0.80000])
            fitted_text("v0.1.0", 11.62354, 2.80000);
    }
}
