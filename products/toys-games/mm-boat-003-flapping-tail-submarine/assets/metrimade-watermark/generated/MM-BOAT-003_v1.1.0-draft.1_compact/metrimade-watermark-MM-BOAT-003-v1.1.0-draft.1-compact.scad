...
module watermark_profile_core() {
    union() {
        translate([0.80000, 0.80000])
            scale(9.60000 / 238)
            import("metrimade-watermark-MM-BOAT-003-v1.1.0-draft.1-compact-icon-source.svg", center = false);
        translate([9.60000, 7.40000])
            fitted_text("metriMade.com", 29.77929, 3.00000);
        translate([9.60000, 4.00000])
            fitted_text("MM-BOAT-003", 28.76892, 2.80000);
        translate([9.60000, 0.80000])
            fitted_text("v1.1.0-draft.1", 23.77146, 2.80000);
    }
}
