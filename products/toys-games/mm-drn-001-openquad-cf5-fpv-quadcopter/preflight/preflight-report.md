# Retrospective 3D-design preflight — Openquad Cf5 Fpv Quadcopter

`Openquad Cf5 Fpv Quadcopter | C3 (52.5/100) | R0 | K3 | Lane E | NOT_AUTONOMOUSLY_RELEASABLE`
...
- Purpose: Modular five-inch FPV quadcopter research frame using four 10 x 10 x 1 mm carbon square tubes, printed PA-CF nodes and common 30.5 mm electronics.
...
|---|---|---:|---:|---|
| `IF-ENV-MEC-LOD-BODY-001` | Printed product to supervised use environment | E0 | K3 | PLANNED |
...
- `validation/transient-render-audit-summary.json`
- `validation/import-source-validation-report.md`
- `validation/import-source-design-metrics.json`
- `validation/import-scad-sync-report.json`
