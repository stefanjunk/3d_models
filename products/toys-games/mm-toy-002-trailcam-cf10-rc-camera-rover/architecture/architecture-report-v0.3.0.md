...
|---|---|---|---|---|---|
| DEC-CONCEPT-001 | open | Approve this functional decomposition before production CAD; concept revision 0.3.0-r3 was approved on 2026-08-29. | Requirements revision 0.3.0 and concept r3 are approved; the decomposition awaits explicit human approval. | User approval or corrections naming the decomposition direction. | proxy, component, integration, manufacturing, physical, release |
