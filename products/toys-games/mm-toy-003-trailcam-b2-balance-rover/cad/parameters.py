...
BATTERY_CRADLE_BASE_Z_MM = 112.0
BATTERY_CRADLE_TOP_Z_MM = 150.0
BATTERY_CROSSMEMBER_Z0_MM = 104.0
BATTERY_CROSSMEMBER_Z1_MM = 110.0
BATTERY_CENTER_MM = (0.0, 0.0, 136.0)
BATTERY_TRIM_MM = 12.0
BATTERY_CRADLE_SLOT_LENGTH_MM = 28.0
BATTERY_CRADLE_SLOT_WIDTH_MM = 4.2
UPPER_CROSSMEMBER_Z0_MM = 152.0
UPPER_CROSSMEMBER_Z1_MM = 158.0
CONTROL_TRAY_Z_MM = 160.0
CONTROL_STACK_MASS_CENTER_Z_MM = 176.0
CAMERA_ENVELOPE_MM = (22.0, 19.0, 19.0)  # X/Y/Z, RunCam class proxy
CAMERA_X_SHIFT_MM = 8.0
CAMERA_CENTER_MM = (81.0, 0.0, 139.5)
...
assert BATTERY_CENTER_MM[2] + BATTERY_ENVELOPE_MM[2] / 2.0 < CONTROL_TRAY_Z_MM
assert (BATTERY_CRADLE_SLOT_LENGTH_MM - M3_CLEARANCE_MM) / 2.0 >= BATTERY_TRIM_MM
