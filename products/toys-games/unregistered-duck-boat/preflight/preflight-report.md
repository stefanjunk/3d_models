# Retrospective 3D-design preflight — Unregistered Duck Boat

`Unregistered Duck Boat | C3 (44.0/100) | R0 | K1 | Lane E | LOW_UNKNOWN`
...
- Purpose: Develop a duck-shaped printable boat concept for supervised play or display; flotation and propulsion are not yet defined.
...
|---|---|---:|---:|---|
| `IF-ENV-MEC-LOD-BODY-001` | Printed product to supervised use environment | E0 | K1 | PLANNED |
