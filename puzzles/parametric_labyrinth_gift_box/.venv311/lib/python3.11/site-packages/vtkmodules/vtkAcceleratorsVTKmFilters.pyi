...
class vtkmHistogramSampling(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    number_of_bins:'getset_descriptor'
    sample_fraction:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfBins(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkmHistogramSampling': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkmHistogramSampling': ...
    def SetNumberOfBins(self, _arg:int) -> None: ...
    def SetSampleFraction(self, _arg:float) -> None: ...
