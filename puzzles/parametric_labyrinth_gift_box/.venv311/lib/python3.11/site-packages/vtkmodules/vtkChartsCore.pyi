...
class vtkAxis(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    CUSTOM:int
    FIXED:int
    FIXED_NOTATION:'Notations'
    LEFT:'Location'
    PARALLEL:'Location'
    PRINTF_NOTATION:'Notations'
    RIGHT:'Location'
    SCIENTIFIC_NOTATION:'Notations'
    STANDARD_NOTATION:'Notations'
    STD_FORMAT_NOTATION:'Notations'
    TICK_SIMPLE:int
...
class vtkChart(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    @overload
    def GetSelectionModeFromMouseModifiers(self, mouseEvent:'vtkContextMouseEvent') -> int: ...
    @overload
    @staticmethod
    def GetSelectionModeFromMouseModifiers(mouseEvent:'vtkContextMouseEvent', currentSelectionMode:int) -> int: ...
...
class vtkColorLegend(vtkChartLegend):
    ...
    def GetTextureSize(self, w:float, h:float) -> None: ...
    def GetTitle(self) -> str: ...
