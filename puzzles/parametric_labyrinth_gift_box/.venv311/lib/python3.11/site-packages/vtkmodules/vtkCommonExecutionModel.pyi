...
class vtkAlgorithm(vtkmodules.vtkCommonCore.vtkObject):
    ...
    number_of_input_array_specifications:'getset_descriptor'
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetNumberOfInputArraySpecifications(self) -> int: ...
    ...
    def ResetInputArraySpecifications(self) -> bool: ...
    @staticmethod
    ...
    @overload
    def SetInputArrayToProcess(self, name:str, fieldAssociation:int, component:int=...) -> None: ...
    @overload
    def SetInputArrayToProcess(self, idx:int, port:int, connection:int, fieldAssociation:int, name:str) -> None: ...
    @overload
    def SetInputArrayToProcess(self, idx:int, port:int, connection:int, fieldAssociation:int, name:str, component:int) -> None: ...
    @overload
    def SetInputArrayToProcess(self, idx:int, port:int, connection:int, fieldAssociation:int, fieldAttributeType:int) -> None: ...
    @overload
    def SetInputArrayToProcess(self, idx:int, port:int, connection:int, fieldAssociation:int, fieldAttributeType:int, component:int) -> None: ...
    @overload
    ...
    @overload
    def SetInputArrayToProcess(self, idx:int, port:int, connection:int, fieldAssociation:str, attributeTypeorName:str, component:str) -> None: ...
    @overload
...
class vtkExtentSplitter(vtkmodules.vtkCommonCore.vtkObject):
    number_of_sub_extents:'getset_descriptor'
