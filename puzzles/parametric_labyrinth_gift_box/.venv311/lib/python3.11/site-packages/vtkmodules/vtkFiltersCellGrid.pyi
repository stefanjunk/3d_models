...
class vtkCellGridSampleQuery(vtkmodules.vtkCommonDataModel.vtkCellGridQuery):
    class PassType(int): ...
    CountOutputs:'PassType'
    GenerateOutputs:'PassType'
    include_source_cell_info:'getset_descriptor'
    include_source_cell_site:'getset_descriptor'
    input:'getset_descriptor'
    maximum_parametric_dimension:'getset_descriptor'
    output:'getset_descriptor'
    source_cell_id_column:'getset_descriptor'
    source_cell_site_column:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def AddOutputSamples(self, inputCellType:'vtkStringToken', numberOfOutputs:int) -> None: ...
    def GetIncludeSourceCellInfo(self) -> bool: ...
    def GetIncludeSourceCellSite(self) -> bool: ...
    def GetInput(self) -> 'vtkCellGrid': ...
    def GetMaximumParametricDimension(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOutput(self) -> 'vtkTable': ...
    def GetOutputAttributeColumn(self, inputAttribute:'vtkCellAttribute') -> 'vtkDataArray': ...
    def GetSampleOffset(self, inputCellType:'vtkStringToken') -> int: ...
    def GetSourceCellIdColumn(self) -> 'vtkIdTypeArray': ...
    def GetSourceCellSiteColumn(self) -> 'vtkDataArray': ...
    def IncludeSourceCellInfoOff(self) -> None: ...
    def IncludeSourceCellInfoOn(self) -> None: ...
    def IncludeSourceCellSiteOff(self) -> None: ...
    def IncludeSourceCellSiteOn(self) -> None: ...
    def Initialize(self) -> bool: ...
    def IsA(self, type:str) -> int: ...
    def IsAnotherPassRequired(self) -> bool: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkCellGridSampleQuery': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkCellGridSampleQuery': ...
    def SetIncludeSourceCellInfo(self, _arg:bool) -> None: ...
    def SetIncludeSourceCellSite(self, _arg:bool) -> None: ...
    def SetInput(self, _arg:'vtkCellGrid') -> None: ...
    def SetMaximumParametricDimension(self, _arg:int) -> None: ...
    def SetOutput(self, _arg:'vtkTable') -> None: ...
...
class vtkDGCell(vtkmodules.vtkCommonDataModel.vtkCellMetadata):
    ...
    number_of_cell_sources:'getset_descriptor'
