...
class vtkSelector(vtkmodules.vtkCommonCore.vtkObject):
    insidedness_array_name:'getset_descriptor'
...
class vtkConvertSelection(vtkmodules.vtkCommonExecutionModel.vtkSelectionAlgorithm):
    allow_missing_array:'getset_descriptor'
    array_name:'getset_descriptor'
    array_names:'getset_descriptor'
    data_object_connection:'getset_descriptor'
    input_field_type:'getset_descriptor'
    match_any_values:'getset_descriptor'
...
class vtkExtractBlock(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    maintain_structure:'getset_descriptor'
    prune_output:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkExtractBlockUsingDataAssembly(vtkmodules.vtkCommonExecutionModel.vtkCompositeDataSetAlgorithm):
    ...
    number_of_selectors:'getset_descriptor'
    prune_data_assembly:'getset_descriptor'
    select_subtrees:'getset_descriptor'
...
class vtkExtractDataArraysOverTime(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    report_statistics_only:'getset_descriptor'
    use_global_i_ds:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkExtractExodusGlobalTemporalVariables(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    auto_detect_global_temporal_data_arrays:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkExtractGeometry(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    extract_boundary_cells:'getset_descriptor'
...
class vtkExtractSelectedRows(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    add_original_row_ids_array:'getset_descriptor'
...
class vtkExtractSelection(vtkmodules.vtkCommonExecutionModel.vtkDataObjectAlgorithm):
    hyper_tree_grid_to_unstructured_grid:'getset_descriptor'
...
class vtkExtractTensorComponents(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    extract_normals:'getset_descriptor'
    extract_scalars:'getset_descriptor'
    extract_t_coords:'getset_descriptor'
    extract_vectors:'getset_descriptor'
    normal_components:'getset_descriptor'
    normalize_normals:'getset_descriptor'
    number_of_t_coords:'getset_descriptor'
    number_of_t_coords_max_value:'getset_descriptor'
    number_of_t_coords_min_value:'getset_descriptor'
    output_precision:'getset_descriptor'
    pass_tensors_to_output:'getset_descriptor'
    scalar_components:'getset_descriptor'
    scalar_mode:'getset_descriptor'
    t_coord_components:'getset_descriptor'
    vector_components:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkExtractTimeSteps(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    time_estimation_mode:'getset_descriptor'
    time_step_interval:'getset_descriptor'
    use_range:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkExtractVectorComponents(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    extract_to_field_data:'getset_descriptor'
    input_data:'getset_descriptor'
    vx_component:'getset_descriptor'
    vy_component:'getset_descriptor'
    vz_component:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
