...
class vtkAnnotationLink(vtkmodules.vtkCommonExecutionModel.vtkAnnotationLayersAlgorithm):
    ...
    number_of_domain_maps:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkBlockIdScalars(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetTraverseSubTree(self) -> bool: ...
    def GetVisitOnlyLeaves(self) -> bool: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    def SetTraverseSubTree(self, _arg:bool) -> None: ...
    def SetVisitOnlyLeaves(self, _arg:bool) -> None: ...
...
class vtkCellValidator(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    auto_tolerance:'getset_descriptor'
    planarity_tolerance:'getset_descriptor'
    tolerance:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def AutoToleranceOff(self) -> None: ...
    def AutoToleranceOn(self) -> None: ...
    @overload
    @staticmethod
    def Check(__a:'vtkGenericCell', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkCell', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkEmptyCell', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkVertex', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkPolyVertex', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkLine', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkPolyLine', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkTriangle', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkTriangleStrip', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkPolygon', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkPixel', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkQuad', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkTetra', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkVoxel', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkHexahedron', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkWedge', tolerance:float) -> 'vtkCellStatus': ...
    @overload
    @staticmethod
    def Check(__a:'vtkPyramid', tolerance:float) -> 'vtkCellStatus': ...
    def GetAutoTolerance(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    @staticmethod
    def GetPlanarityTolerance() -> float: ...
    def GetTolerance(self) -> float: ...
    ...
    def SetAutoTolerance(self, _arg:int) -> None: ...
    @staticmethod
    def SetPlanarityTolerance(tolerance:float) -> None: ...
    def SetTolerance(self, _arg:float) -> None: ...
...
class vtkIconGlyphFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    icon_scaling_to_scaling_off:'getset_descriptor'
...
class vtkPointsMatchingTransformFilter(vtkmodules.vtkCommonExecutionModel.vtkPointSetAlgorithm):
    m_time:'getset_descriptor'
    rigid_transform:'getset_descriptor'
    source_matrix:'getset_descriptor'
    source_point1:'getset_descriptor'
    source_point2:'getset_descriptor'
    source_point3:'getset_descriptor'
    source_point4:'getset_descriptor'
    target_matrix:'getset_descriptor'
    target_point1:'getset_descriptor'
    target_point2:'getset_descriptor'
    target_point3:'getset_descriptor'
    target_point4:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetMTime(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetRigidTransform(self) -> bool: ...
    def GetSourceMatrix(self) -> 'vtkMatrix4x4': ...
    def GetTargetMatrix(self) -> 'vtkMatrix4x4': ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkPointsMatchingTransformFilter': ...
    def RigidTransformOff(self) -> None: ...
    def RigidTransformOn(self) -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkPointsMatchingTransformFilter': ...
    def SetRigidTransform(self, _arg:bool) -> None: ...
    def SetSourceMatrix(self, __a:'vtkMatrix4x4') -> None: ...
    def SetSourcePoint(self, index:int, x:float, y:float, z:float) -> None: ...
    def SetSourcePoint1(self, x:float, y:float, z:float) -> None: ...
    def SetSourcePoint2(self, x:float, y:float, z:float) -> None: ...
    def SetSourcePoint3(self, x:float, y:float, z:float) -> None: ...
    def SetSourcePoint4(self, x:float, y:float, z:float) -> None: ...
    def SetTargetMatrix(self, __a:'vtkMatrix4x4') -> None: ...
    def SetTargetPoint(self, index:int, x:float, y:float, z:float) -> None: ...
    def SetTargetPoint1(self, x:float, y:float, z:float) -> None: ...
    def SetTargetPoint2(self, x:float, y:float, z:float) -> None: ...
    def SetTargetPoint3(self, x:float, y:float, z:float) -> None: ...
    def SetTargetPoint4(self, x:float, y:float, z:float) -> None: ...
...
class vtkSplineFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    generate_t_coords_to_off:'getset_descriptor'
...
class vtkSumTables(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    source_connection:'getset_descriptor'
    source_data:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkSumTables': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkSumTables': ...
    def SetSourceConnection(self, source:'vtkAlgorithmOutput') -> None: ...
    def SetSourceData(self, source:'vtkTable') -> None: ...
    @staticmethod
    def SumTables(aa:'vtkTable', bb:'vtkTable', checkOnly:bool=False, allowAbstractColumns:bool=False) -> bool: ...
...
class vtkTableBasedClipDataSet(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    ...
    clip_function:'getset_descriptor'
    clipped_output:'getset_descriptor'
    generate_clip_point_types:'getset_descriptor'
    generate_clip_scalars:'getset_descriptor'
    generate_clipped_output:'getset_descriptor'
    inside_out:'getset_descriptor'
    locator:'getset_descriptor'
    ...
    value:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GenerateClipPointTypesOff(self) -> None: ...
    def GenerateClipPointTypesOn(self) -> None: ...
    def GenerateClipScalarsOff(self) -> None: ...
    def GenerateClipScalarsOn(self) -> None: ...
    def GenerateClippedOutputOff(self) -> None: ...
    def GenerateClippedOutputOn(self) -> None: ...
    ...
    def GetClipFunction(self) -> 'vtkImplicitFunction': ...
    def GetClippedOutput(self) -> 'vtkUnstructuredGrid': ...
    def GetGenerateClipPointTypes(self) -> bool: ...
    def GetGenerateClipScalars(self) -> int: ...
    def GetGenerateClippedOutput(self) -> int: ...
    def GetInsideOut(self) -> int: ...
    def GetLocator(self) -> 'vtkIncrementalPointLocator': ...
    ...
    def SetClipFunction(self, __a:'vtkImplicitFunction') -> None: ...
    def SetGenerateClipPointTypes(self, _arg:bool) -> None: ...
    def SetGenerateClipScalars(self, _arg:int) -> None: ...
    def SetGenerateClippedOutput(self, _arg:int) -> None: ...
    def SetInsideOut(self, _arg:int) -> None: ...
    def SetLocator(self, locator:'vtkIncrementalPointLocator') -> None: ...
