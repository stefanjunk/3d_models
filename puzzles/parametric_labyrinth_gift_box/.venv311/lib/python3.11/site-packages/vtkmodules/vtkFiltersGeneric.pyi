...
class vtkGenericClip(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    ...
    input_scalars_selection:'getset_descriptor'
...
class vtkGenericDataSetTessellator(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    keep_cell_ids:'getset_descriptor'
    locator:'getset_descriptor'
    m_time:'getset_descriptor'
...
class vtkGenericGlyph3DFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    index_mode_to_off:'getset_descriptor'
    input_normals_selection:'getset_descriptor'
    input_scalars_selection:'getset_descriptor'
    input_vectors_selection:'getset_descriptor'
    ...
    scale_mode_to_data_scaling_off:'getset_descriptor'
    scaling:'getset_descriptor'
    source_data:'getset_descriptor'
    vector_mode:'getset_descriptor'
    vector_mode_to_vector_rotation_off:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkGenericStreamTracer(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    initial_integration_step_unit:'getset_descriptor'
    input_vectors_selection:'getset_descriptor'
    ...
    maximum_integration_step_unit:'getset_descriptor'
    maximum_number_of_steps:'getset_descriptor'
    maximum_propagation:'getset_descriptor'
    maximum_propagation_unit:'getset_descriptor'
    minimum_integration_step:'getset_descriptor'
    minimum_integration_step_unit:'getset_descriptor'
