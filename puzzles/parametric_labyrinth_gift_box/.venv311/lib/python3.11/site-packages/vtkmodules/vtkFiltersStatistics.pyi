...
class vtkStatisticsAlgorithm(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    algorithm_parameters:'getset_descriptor'
    ...
    maximum_number_of_columns_per_request:'getset_descriptor'
    number_of_primary_tables:'getset_descriptor'
    number_of_requests:'getset_descriptor'
    output_model:'getset_descriptor'
    skip_invalid_values:'getset_descriptor'
    ...
    def Aggregate(self, collection:'vtkDataObjectCollection', model:'vtkStatisticalModel') -> bool: ...
    def AssessOptionOff(self) -> None: ...
    def AssessOptionOn(self) -> None: ...
    def CopyRequests(self, requests:'vtkStatisticsAlgorithmPrivate') -> bool: ...
    def DeriveOptionOff(self) -> None: ...
    def DeriveOptionOn(self) -> None: ...
    def GetAlgorithmParameters(self) -> str: ...
    ...
    def GetMaximumNumberOfColumnsPerRequest(self) -> int: ...
    ...
    def GetOutputModel(self) -> 'vtkStatisticalModel': ...
    def GetSkipInvalidValues(self) -> bool: ...
    def GetTestOption(self) -> bool: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def LearnOptionOff(self) -> None: ...
    def LearnOptionOn(self) -> None: ...
    @staticmethod
    def NewFromAlgorithmParameters(algorithmParameters:str) -> 'vtkStatisticsAlgorithm': ...
    ...
    def SetSkipInvalidValues(self, _arg:bool) -> None: ...
    def SetTestOption(self, _arg:bool) -> None: ...
    def SkipInvalidValuesOff(self) -> None: ...
    def SkipInvalidValuesOn(self) -> None: ...
    def TestOptionOff(self) -> None: ...
    def TestOptionOn(self) -> None: ...

class vtkAutoCorrelativeStatistics(vtkStatisticsAlgorithm):
    maximum_number_of_columns_per_request:'getset_descriptor'
    slice_cardinality:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def Aggregate(self, __a:'vtkDataObjectCollection', __b:'vtkStatisticalModel') -> bool: ...
    def GetMaximumNumberOfColumnsPerRequest(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkDescriptiveStatistics(vtkStatisticsAlgorithm):
    ...
    def __init__(self, **properties:Any) -> None: ...
    def Aggregate(self, __a:'vtkDataObjectCollection', __b:'vtkStatisticalModel') -> bool: ...
    def AppendAlgorithmParameters(self, algorithmParameters:str) -> None: ...
    def ConsumeNextAlgorithmParameter(self, parameterName:'vtkStringToken', algorithmParameters:str) -> int: ...
    def GetDistributionForField(self, fieldName:str, mean:float, variance:float, stdev:float, skewness:float, kurtosis:float) -> bool: ...
    def GetMaximumNumberOfColumnsPerRequest(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkExtractStatisticalModelTables(vtkmodules.vtkCommonExecutionModel.vtkPartitionedDataSetCollectionAlgorithm):
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkExtractStatisticalModelTables': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkExtractStatisticalModelTables': ...
...
class vtkVisualStatistics(vtkDescriptiveStatistics):
    number_of_bins:'getset_descriptor'
    number_of_bins_max_value:'getset_descriptor'
    number_of_bins_min_value:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def AppendAlgorithmParameters(self, algorithmParameters:str) -> None: ...
    def ConsumeNextAlgorithmParameter(self, parameterName:'vtkStringToken', algorithmParameters:str) -> int: ...
    def GetHistogramForField(self, fieldName:str) -> 'vtkDataArray': ...
    def GetNumberOfBins(self) -> int: ...
    def GetNumberOfBinsMaxValue(self) -> int: ...
    def GetNumberOfBinsMinValue(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkVisualStatistics': ...
    def ResetFieldRanges(self) -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkVisualStatistics': ...
    def SetFieldRange(self, field:str, lo:float, hi:float) -> None: ...
