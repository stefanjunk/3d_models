...
class vtkWriter(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    @overload
    @staticmethod
    def EncodeString(resname:str, name:str) -> None: ...
    @overload
    @staticmethod
    def EncodeString(resname:str, name:str, doublePercent:bool) -> None: ...
    @overload
...
class vtkDelimitedTextWriter(vtkWriter):
    ...
    def SetNotationToFixed(self) -> None: ...
    def SetNotationToScientific(self) -> None: ...
    def SetNotationToStandard(self) -> None: ...
...
class vtkSortFileNames(vtkmodules.vtkCommonCore.vtkObject):
    ...
    number_of_groups:'getset_descriptor'
