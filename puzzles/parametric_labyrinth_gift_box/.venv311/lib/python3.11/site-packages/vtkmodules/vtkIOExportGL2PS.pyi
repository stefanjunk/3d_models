...
class vtkGL2PSExporter(vtkmodules.vtkIOExport.vtkExporter):
    ...
    best_root:'getset_descriptor'
    buffer_size:'getset_descriptor'
    compress:'getset_descriptor'
    draw_background:'getset_descriptor'
    file_format:'getset_descriptor'
    file_prefix:'getset_descriptor'
    landscape:'getset_descriptor'
    line_width_factor:'getset_descriptor'
    occlusion_cull:'getset_descriptor'
    point_size_factor:'getset_descriptor'
    ps3_shading:'getset_descriptor'
    raster_exclusions:'getset_descriptor'
    silent:'getset_descriptor'
    simple_line_offset:'getset_descriptor'
    sort:'getset_descriptor'
    sort_to_off:'getset_descriptor'
    text:'getset_descriptor'
    text_as_path:'getset_descriptor'
    title:'getset_descriptor'
    write3d_props_as_raster_image:'getset_descriptor'
