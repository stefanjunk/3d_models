...
class vtkMINCImageAttributes(vtkmodules.vtkCommonCore.vtkObject):
    ...
    dimension_lengths:'getset_descriptor'
    dimension_names:'getset_descriptor'
    image_max:'getset_descriptor'
    image_min:'getset_descriptor'
    name:'getset_descriptor'
    number_of_image_min_max_dimensions:'getset_descriptor'
    validate_attributes:'getset_descriptor'
    variable_names:'getset_descriptor'
...
class vtkMINCImageWriter(vtkmodules.vtkIOImage.vtkImageWriter):
    ...
    file_extensions:'getset_descriptor'
    file_name:'getset_descriptor'
    history_addition:'getset_descriptor'
    image_attributes:'getset_descriptor'
    rescale_intercept:'getset_descriptor'
    rescale_slope:'getset_descriptor'
    strict_validation:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetDescriptiveName(self) -> str: ...
    def GetDirectionCosines(self) -> 'vtkMatrix4x4': ...
    def GetFileExtensions(self) -> str: ...
...
class vtkMNITagPointReader(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    number_of_volumes:'getset_descriptor'
    patient_ids:'getset_descriptor'
    points:'getset_descriptor'
    structure_ids:'getset_descriptor'
