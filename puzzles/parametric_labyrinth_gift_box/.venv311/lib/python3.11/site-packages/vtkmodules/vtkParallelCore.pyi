...
class vtkMultiProcessStream(object):
    ...
    @overload
    def Push(self, array:'vtkDataArray') -> None: ...
    @overload
    def Push(self, array:'vtkStringArray') -> None: ...
...
class vtkPExecutableRunner(vtkmodules.vtkCommonSystem.vtkExecutableRunner):
    execution_process_id:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def Execute(self) -> None: ...
    def GetExecutionProcessId(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkPExecutableRunner': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkPExecutableRunner': ...
    def SetExecutionProcessId(self, _arg:int) -> None: ...
...
class vtkProcessGroup(vtkmodules.vtkCommonCore.vtkObject):
    communicator:'getset_descriptor'
    local_process_id:'getset_descriptor'
    number_of_process_ids:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
