...
class vtkBlockItem(vtkContextItem):
    ...
    RIGHT:int
    TOP:int
    auto_compute_dimensions:'getset_descriptor'
    ...
    mouse_over_brush:'getset_descriptor'
...
class vtkBrush(vtkmodules.vtkCommonCore.vtkObject):
    ...
    color_object:'getset_descriptor'
    opacity:'getset_descriptor'
    opacity_f:'getset_descriptor'
    texture:'getset_descriptor'
    texture_properties:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkContext2D(vtkmodules.vtkCommonCore.vtkObject):
    brush:'getset_descriptor'
    buffer_id_mode:'getset_descriptor'
    context3d:'getset_descriptor'
    device:'getset_descriptor'
    pen:'getset_descriptor'
    text_prop:'getset_descriptor'
    transform:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkContextDevice2D(vtkmodules.vtkCommonCore.vtkObject):
    ...
    text_prop:'getset_descriptor'
    viewport_rect:'getset_descriptor'
...
class vtkContextMouseEvent(object):
    ...
    last_scene_pos:'getset_descriptor'
    last_screen_pos:'getset_descriptor'
    modifiers:'getset_descriptor'
    pos:'getset_descriptor'
    scene_pos:'getset_descriptor'
    screen_pos:'getset_descriptor'
    @overload
    def __init__(self) -> None: ...
    @overload
...
class vtkContextScene(vtkmodules.vtkCommonCore.vtkObject):
    ...
    buffer_id:'getset_descriptor'
    dirty:'getset_descriptor'
    geometry:'getset_descriptor'
    last_painter:'getset_descriptor'
    logical_tile_scale:'getset_descriptor'
    number_of_items:'getset_descriptor'
    origin:'getset_descriptor'
    picked_item:'getset_descriptor'
    renderer:'getset_descriptor'
    scale_tiles:'getset_descriptor'
    scene_bottom:'getset_descriptor'
    scene_height:'getset_descriptor'
    scene_left:'getset_descriptor'
    scene_width:'getset_descriptor'
    transform:'getset_descriptor'
    use_buffer_id:'getset_descriptor'
    view_height:'getset_descriptor'
    view_width:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def AddItem(self, item:'vtkAbstractContextItem') -> int: ...
    def ClearItems(self) -> None: ...
...
class vtkContextTransform(vtkAbstractContextItem):
    pan_modifier:'getset_descriptor'
    pan_mouse_button:'getset_descriptor'
    pan_y_on_mouse_wheel:'getset_descriptor'
    secondary_pan_modifier:'getset_descriptor'
    secondary_pan_mouse_button:'getset_descriptor'
    secondary_zoom_modifier:'getset_descriptor'
    secondary_zoom_mouse_button:'getset_descriptor'
    transform:'getset_descriptor'
    zoom_modifier:'getset_descriptor'
    zoom_mouse_button:'getset_descriptor'
    zoom_on_mouse_wheel:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def AddItem(self, item:'vtkAbstractContextItem') -> int: ...
    def GetItem(self, index:int) -> 'vtkAbstractContextItem': ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
...
class vtkPolyDataItem(vtkContextItem):
    mapped_colors:'getset_descriptor'
