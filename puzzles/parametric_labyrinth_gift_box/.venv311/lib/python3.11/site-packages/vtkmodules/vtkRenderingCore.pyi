...
class vtkProp(vtkmodules.vtkCommonCore.vtkObject):
    ...
    number_of_consumers:'getset_descriptor'
    ...
    @staticmethod
    def GENERAL_TEXTURE_TRANSFORM() -> 'vtkInformationDoubleVectorKey': ...
    @staticmethod
    def GENERAL_TEXTURE_UNIT() -> 'vtkInformationIntegerKey': ...
    @staticmethod
...
class vtkActor2DCollection(vtkPropCollection):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IndexOfFirstOccurrence(self, a:'vtkActor2D') -> int: ...
    def IsA(self, type:str) -> int: ...
...
class vtkCellGraphicsPrimitiveMap(vtkmodules.vtkCommonCore.vtkObject):
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkCellGraphicsPrimitiveMap': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkCellGraphicsPrimitiveMap': ...
...
class vtkMapper(vtkAbstractMapper3D):
    ...
    resolve_coincident_topology_to_off:'getset_descriptor'
...
class vtkCompositeDataDisplayAttributes(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetBlockTexture(self, dataObject:'vtkDataObject') -> 'vtkTexture': ...
    ...
    def HasBlockTexture(self, dataObject:'vtkDataObject') -> bool: ...
    def HasBlockTextures(self) -> bool: ...
    ...
    def RemoveBlockTexture(self, dataObject:'vtkDataObject') -> None: ...
    def RemoveBlockTextures(self) -> None: ...
    ...
    def SetBlockTexture(self, dataObject:'vtkDataObject', texture:'vtkTexture') -> None: ...
...
class vtkCompositePolyDataMapper(vtkPolyDataMapper):
    ...
    def GetBlockTexture(self, index:int) -> 'vtkTexture': ...
    ...
    def RemoveBlockScalarModes(self) -> None: ...
    def RemoveBlockTexture(self, index:int) -> None: ...
    def RemoveBlockTextures(self) -> None: ...
    def RemoveBlockVisibilities(self) -> None: ...
    ...
    def SetBlockTexture(self, index:int, texture:'vtkTexture') -> None: ...
    def SetBlockTextureImage(self, index:int, textureImage:'vtkImageData') -> None: ...
...
class vtkProperty(vtkmodules.vtkCommonCore.vtkObject):
    class LineJoinType(int):
        MiterJoin:'LineJoinType'
        NoJoin:'LineJoinType'
        RoundCapRoundJoin:'LineJoinType'
    ...
    def GetLineJoin(self) -> 'LineJoinType': ...
    ...
    def SetLineJoin(self, _arg:'LineJoinType') -> None: ...
...
class vtkRenderer(vtkViewport):
    ...
    environment_rotation_matrix:'getset_descriptor'
    ...
    @overload
    def GetEnvironmentRight(self) -> Pointer: ...
    @overload
    def GetEnvironmentRight(self, vectorRightX:float, vectorRightY:float, vectorRightZ:float) -> None: ...
    @overload
    def GetEnvironmentRight(self, vectorRight:MutableSequence[float]) -> None: ...
    def GetEnvironmentRotationMatrix(self) -> 'vtkMatrix3x3': ...
    def GetEnvironmentTexture(self) -> 'vtkTexture': ...
    @overload
    def GetEnvironmentUp(self) -> Pointer: ...
    @overload
    def GetEnvironmentUp(self, vectorUpX:float, vectorUpY:float, vectorUpZ:float) -> None: ...
    @overload
    def GetEnvironmentUp(self, vectorUp:MutableSequence[float]) -> None: ...
    ...
    @overload
    def ResetCameraScreenSpace(self, offsetRatio:float=0.9) -> bool: ...
    @overload
    ...
    @overload
    def SetEnvironmentRight(self, vectorRightX:float, vectorRightY:float, vectorRightZ:float) -> None: ...
    @overload
    def SetEnvironmentRight(self, vectorRight:MutableSequence[float]) -> None: ...
    def SetEnvironmentRotationMatrix(self, matrix:'vtkMatrix3x3') -> None: ...
    ...
    @overload
    def SetEnvironmentUp(self, vectorUpX:float, vectorUpY:float, vectorUpZ:float) -> None: ...
    @overload
    def SetEnvironmentUp(self, vectorUp:MutableSequence[float]) -> None: ...
...
class vtkRendererSource(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    depth_values_only:'getset_descriptor'
    input:'getset_descriptor'
    m_time:'getset_descriptor'
...
class vtkTextActor(vtkTexturedActor2D):
    ...
    font_scale_exponent:'getset_descriptor'
    input:'getset_descriptor'
    ...
    def GetFontScaleExponent(self) -> float: ...
    def GetInput(self) -> str: ...
    ...
    def SetFontScaleExponent(self, _arg:float) -> None: ...
...
class vtkVolumeProperty(vtkmodules.vtkCommonCore.vtkObject):
    ...
    m_time:'getset_descriptor'
    number_of_gradient_opacity_functions:'getset_descriptor'
    number_of_gray_transfer_functions:'getset_descriptor'
    number_of_labels:'getset_descriptor'
    number_of_rgb_transfer_functions:'getset_descriptor'
    number_of_scalar_opacity_functions:'getset_descriptor'
    number_of_transfer_function2_ds:'getset_descriptor'
    ...
    def GetGradientOpacityFunction(self, index:int) -> 'vtkPiecewiseFunction': ...
    @overload
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetNumberOfGradientOpacityFunctions(self) -> int: ...
    def GetNumberOfGrayTransferFunctions(self) -> int: ...
    def GetNumberOfLabels(self) -> int: ...
    def GetNumberOfRGBTransferFunctions(self) -> int: ...
    def GetNumberOfScalarOpacityFunctions(self) -> int: ...
    def GetNumberOfTransferFunction2Ds(self) -> int: ...
    @overload
    ...
    def GetScalarOpacityFunction(self, index:int) -> 'vtkPiecewiseFunction': ...
    @overload
    ...
    def SetGradientOpacityFunction(self, index:int, function:'vtkPiecewiseFunction') -> None: ...
    def SetGrayTransferFunction(self, index:int, function:'vtkPiecewiseFunction') -> None: ...
    ...
    def SetRGBTransferFunction(self, index:int, function:'vtkColorTransferFunction') -> None: ...
    @overload
    ...
    def SetScalarOpacityFunction(self, index:int, function:'vtkPiecewiseFunction') -> None: ...
    @overload
